                ...
                <div class="jarviswidget" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-togglebutton="false"
                    ...
                    <div>
                        <div class="widget-body no-padding">
                            <form class="form-horizontal" method="post" action="<?=site_url('bkproduct/edit_product_list/'.$plist->PLID)?>" enctype="multipart/form-data">
                                <div id="content">
                                    <fieldset>
                                ...
                                <div class="widget-footer">
                                    ...
                                    <button type="button" class="btn btn-default" onclick="location.href='<?= site_url("bkproduct") ?>';">返回</button>
                                </div>
                            </form>
                        </div>
                    </div>
