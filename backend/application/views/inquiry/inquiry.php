                                    ...
                                    <? if ($inquiry) { ?>
                                        <? foreach ($inquiry as $row) { ?>
                                            <tr>
                                                ...
                                                <td><?= $row->phone ?></td>
                                                <td>
                                                    <a href="<?= site_url('bkinquiry/view_inquiry/' . $row->IQID) ?>" class="btn btn-default" style=""><i class="fa fa-gear"></i><span class="hidden-tablet"> 編輯 </span></a>
                                                    <a href="<?= site_url('bkinquiry/delete_inquiry/' . $row->IQID) ?>" class="btn btn-danger" onclick="return confirm('確定要刪除?');"><i class="glyphicon glyphicon-trash"></i><span class="hidden-tablet"> 刪除 </span></a>
                                                </td>
                                            </tr>
                                        <? } ?>
                                    <? } ?>
