                ...
                <div class="jarviswidget" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-togglebutton="false"
                    ...
                    <div>
                        <div class="widget-body no-padding">
                            <form class="form-horizontal" method="post" action="<?=site_url('backend/bknews/edit_news/'.$news->NID)?>" enctype="multipart/form-data">
                                <div id="content">
                                    <fieldset>
                                        <legend>編輯新聞</legend>
                                ...
                                <div class="widget-footer">
                                    ...
                                    <button type="button" class="btn btn-default" onclick="location.href='<?= site_url("backend/bknews") ?>';">返回</button>
                                </div>
                            </form>
                        </div>
                    </div>
