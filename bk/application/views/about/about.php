                ...
                <div class="jarviswidget" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-togglebutton="false"
                    ...
                    <div>
                        <div class="widget-body no-padding">
                            <form class="form-horizontal" method="post" action="<?= site_url('backend/bkabout') ?>" enctype="multipart/form-data">
                                                                ...
                                                                <div class="widget-body-toolbar">
                                                                    <div class="row">
                                                                        <div class="col-xs-12 text-right">
                                                                            <a class="btn btn-primary" href="<?=site_url('backend/bkabout/add_banner')?>">
                                                                        ...
                                                                        <? if ($banner) { ?>
                                                                            <? foreach ($banner as $row) { ?>
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        <a href="<?= site_url('backend/bkabout/edit_banner/' . $row->ABID) ?>" class="btn btn-default" style=""><i class="fa fa-gear"></i><span class="hidden-tablet"> 編輯 </span></a>
                                                                                        <a href="<?= site_url('backend/bkabout/delete_banner/' . $row->ABID) ?>" class="btn btn-danger" onclick="return confirm('確定要刪除?');"><i class="glyphicon glyphicon-trash"></i><span class="hidden-tablet"> 刪除 </span></a>
                                                                                    </td>
                                                                                </tr>
                                                                            <? } ?>
                                                                        <? } ?>
